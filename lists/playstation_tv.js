...
//Notification
	popup.notify('Powered by PS3™ 4K Pro and Sandro Store.', 20);
  }
...
//Title TopBar
  ...
  showPlaylist(page);
	...
	if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.github.com/LuanTeles/PlayStation-TV/main/lists/animes.m3u:Animes', "directory", {
            title: 'Animes',
			icon: 'https://raw.github.com/LuanTeles/PlayStation-TV/main/icons/animes.png'
        });
    }
	
	if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.github.com/LuanTeles/PlayStation-TV/main/lists/cartoons.m3u:Cartoons', "directory", {
            title: 'Desenhos',
			icon: 'https://raw.github.com/LuanTeles/PlayStation-TV/main/icons/cartoons.png'
        });
    }
	
    if (!service.disableSampleList) {
			page.model.contents = 'grid';
		var item = page.appendItem('m3u:https://raw.github.com/LuanTeles/PlayStation-TV/main/lists/movies.m3u:Movies', "directory", {
            title: 'Filmes',
			icon: 'https://raw.github.com/LuanTeles/PlayStation-TV/main/icons/movies.png'
        });
    }

    if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.github.com/LuanTeles/PlayStation-TV/main/lists/series.m3u:Series', "directory", {
            title: 'Séries',
			icon: 'https://raw.github.com/LuanTeles/PlayStation-TV/main/icons/series.png'
        });
    }
	
	 if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.github.com/LuanTeles/PlayStation-TV/main/lists/telenovelas.m3u:Telenovelas', "directory", {
            title: 'Novelas',
			icon: 'https://raw.github.com/LuanTeles/PlayStation-TV/main/icons/telenovelas.png'
        });
    }
	
	 if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.github.com/LuanTeles/PlayStation-TV/main/lists/documentaries.m3u:Documentaries', "directory", {
            title: 'Documentários',
			icon: 'https://raw.github.com/LuanTeles/PlayStation-TV/main/icons/documentaries.png'
        });
    }
	
	if (!service.disableSampleXMLList) {
	 	page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.github.com/LuanTeles/PlayStation-TV/main/lists/music.m3u:Music', "directory", {
            title: 'Música',
			icon: 'https://raw.github.com/LuanTeles/PlayStation-TV/main/icons/music.png'
        });
    }   

	if (!service.disableSampleList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.github.com/LuanTeles/PlayStation-TV/main/lists/iptv.m3u:IPTV', "directory", {
            title: 'TV',
			icon: 'https://raw.github.com/LuanTeles/PlayStation-TV/main/icons/iptv.png'
        });
    }
	
	if (!service.disableSampleList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.github.com/LuanTeles/PlayStation-TV/main/lists/humor.m3u:Humor', "directory", {
            title: 'Humor',
			icon: 'https://raw.github.com/LuanTeles/PlayStation-TV/main/icons/humor.png'
        });
    }	
